...
<body>
    ...
    <section class="container3">
        ...
        <div class="card">
            ...
            <div class="card-text">
                <p>Impresionante formación natural de rocas de gran tamaño, con diversas formas y colores. Increíble visión que transmite diferentes sensaciones.</p>
            </div>
        </div>
        <div class="card">
            <div class="card-image">
            ...
            <h3>Cañón del Apurímac</h3>
            <div class="card-text">
                <p>Es uno de los más profundos de América y del mundo. La honda quebrada, en la ruta Abancay-Cusco, es un excelente lugar para observar su gran belleza. Sus paisajes son inolvidables porque tiene flora y fauna propia en sus diversos pisos ecológicos. Para su formación, las aguas del río Apurímac bajan con fuerza desde los 5 000 m s.n.m a una gigantesca garganta. Producto de este choque colosal se crea un paisaje que impresiona. El río es ideal para practicar canotaje y cuenta con rápidos de categoría II y IV.</p>
            </div>
        </div>
    </section>
</body>
